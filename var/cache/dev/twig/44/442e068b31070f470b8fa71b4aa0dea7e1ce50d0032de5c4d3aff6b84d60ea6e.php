...
class __TwigTemplate_1f7a258e658b1e8fe99b5965be5a8f905c0a64db612820a1820e3fa7941a1064 extends Twig_Template
{
...
";
    ...
    <div class=\"container\">
      ...
      <h1 class=\"mt-4 mb-3\">Categoria</h1>
      ...
      <div class=\"row\">
        ...
        // line 19
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl((($context["servicioImg"] ?? $this->getContext($context, "servicioImg")) . $this->getAttribute(($context["categoria"] ?? $this->getContext($context, "categoria")), "foto", array()))), "html", null, true);
        echo "\" alt=\"\">
        </div>
        ...
        echo "</h3>
          <p>";
        // line 24
        echo twig_escape_filter($this->env, $this->getAttribute(($context["categoria"] ?? $this->getContext($context, "categoria")), "descripcion", array()), "html", null, true);
        echo "</p>
        </div>
...
";
    ...
    {
        return array (  93 => 24,  89 => 23,  82 => 19,  70 => 9,  61 => 8,  50 => 5,  41 => 4,  11 => 2,);
    }
...
{% block contenido %}
    ...
    <div class=\"container\">
      ...
      <div class=\"row\">
        ...
        <div class=\"col-md-8\">
          <img class=\"img-fluid\" src=\"{{asset(servicioImg~categoria.foto)}}\" alt=\"\">
        </div>

        <div class=\"col-md-4\">
          <h3 class=\"my-3\">{{categoria.nombre}}</h3>
...
{% endblock %}", "frontal/categoria.html.twig", "C:\\xampp2\\htdocs\\symphony34\\symfonyweb\\app\\Resources\\views\\frontal\\categoria.html.twig");
    }
}
