...
class __TwigTemplate_4e105e7a933685c2a3e769227c41b32ec61cc3b66fcf3fcf1f2f8e0726cd0291 extends Twig_Template
{
...
";
    ...
    <div class=\"container\">
      ...
      <div class=\"row\">
        ...
        // line 19
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl((($context["servicioImg"] ?? $this->getContext($context, "servicioImg")) . $this->getAttribute(($context["servicio"] ?? $this->getContext($context, "servicio")), "foto", array()))), "html", null, true);
        echo "\" alt=\"\">
        </div>
...
{% block contenido %}
    ...
    <div class=\"container\">
      ...
      <div class=\"row\">
        ...
        <div class=\"col-md-8\">
          <img class=\"img-fluid\" src=\"{{asset(servicioImg~servicio.foto)}}\" alt=\"\">
        </div>
